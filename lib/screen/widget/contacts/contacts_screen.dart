import 'package:chatbox/screen/widget/contacts/bloc/contacts_cubit.dart';
...
class ContactBody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    context.read<ContactsCubit>().getContact();
            ...
            body: Stack(
              children: [
                ...
                Positioned(
                  ...
                  left: 0,
                  right: 0,
                  child: _buildContactList(context,state),
                )
              ],
            ));
      },
  ...
  Widget _buildContactList(BuildContext context, ContactsState state) {
